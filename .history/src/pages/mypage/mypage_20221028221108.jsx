...
const MyPage = ({authService}) =>{
  ...
  const handleUpdate = (updated) =>{
    ...
    const newScore = myItems.filter((i) => i.collection === 'liarplus'&& i.status === 'active').length - myItems.filter((i) => i.collection === 'liarminus'&& i.status === 'active').length;
    setLiarScore(newScore);
  }
