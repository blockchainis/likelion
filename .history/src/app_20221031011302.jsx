  ...
  <div className={styles.app}>
    ...
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/shop" element={<Shop authService={authService} nickname={nickname} scoreLimit={scoreLimit} myStatus={myStatus} setMystatus={setMystatus} initShopItems={initShopItems} shopItems={shopItems} setShopItems={setShopItems} updateScoreLmit={updateScoreLmit}/>}/>
          <Route path="/mypage" element={<MyPage authService={authService} initItems={initItems} nickname={nickname} editNickname={editNickname} scoreLimit={scoreLimit} myStatus={myStatus} setMystatus={setMystatus} updateScoreLmit={updateScoreLmit}/>}/>
        </Routes>
    </BrowserRouter> 
  </div>)
}
