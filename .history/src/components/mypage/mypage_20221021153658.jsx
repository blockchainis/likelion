                    ...
                    <div className={styles.wallet}>
                        ...
                        <div className={styles.activeItems}>
                            <a href="#" class={styles.activeItem} target='blank'>
                                <img class={styles.activeItemImg} src="../../public/images/logo.png" alt="description" />
                                <div class={styles.activeItemText}>
                                    <span>착용해제</span>
                                </div>
                            </a>
                            <a href="#" class={styles.activeItem} target='blank'>
                                <img class={styles.activeItemImg} src="https://media.istockphoto.com/vectors/old-ticket-vector-id468417164?k=20&m=468417164&s=612x612&w=0&h=fYWkYYqA196n4BJq8RvkAzwpqhhB9ZN58Wzl4marRPo=" alt="description" />
                                <div class={styles.activeItemText}>
                                    <span>착용해제</span>
                                </div>
                            </a>
