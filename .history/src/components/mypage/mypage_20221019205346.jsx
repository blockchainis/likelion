    ...
    <section className={styles.all}>
        ...
        <section className={styles.contents}>
            <div className={styles.profile}>dd
                <img src className={styles.profileImg} src="https://media.istockphoto.com/vectors/dabbing-unicorn-vector-design-vector-id954726306?k=20&m=954726306&s=612x612&w=0&h=2Icz09Ktm0giiVDTwodFwueZ1Cc1g8aFdWQGS7SCjoc=" />
            ...
            <div className={styles.allItems}>
                ...
                <div><button>buy/7000</button></div>
                </div>
                <div className={styles.item}>
                <img src="https://media.istockphoto.com/vectors/old-ticket-vector-id468417164?k=20&m=468417164&s=612x612&w=0&h=fYWkYYqA196n4BJq8RvkAzwpqhhB9ZN58Wzl4marRPo=" alt="" className={styles.itemImg} />
                <div><button >buy/7000</button></div>
