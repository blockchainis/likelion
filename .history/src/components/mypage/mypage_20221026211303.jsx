...
const MyPage = ({authService}) =>{
  ...
  //updatestatus
  const deactive = (id) => {
    const newList = [...myItems, {id: id, src, status:'deactive'}];
    setMyItems(newList);
    console.log(id);
  }
        ...
        <section className={styles.contents}>
                ...
                <div className={styles.status}>
                    <div className={styles.wallet}>
                        ...
                        <div className={styles.activeItems}>
                            {activeItems.map(i => <ActiveItem key={i.id} id={i.id} src={i.src} deactive={deactive}/>)}
                        </div>
            ...
            {filters.map((value,index) => <li key={index}>
                ...
                <div className={styles.allItems}>
                    {filtered.map((i)=> <Item key={i.id} src={i.src} status={i.status}/>)}
            </div>
