...
<div className={styles.item} data-type="active">
    ...
    {status === 'active'? <div><button disabled>착용중</button></div> : status=== 'deactive' ? <div><button  onClick={active}>착용하기</button></div>: <div className={styles.mint}>잔여수량:{i.remain}<br/> <button onClick={buyItem}>구매</button></div>}
