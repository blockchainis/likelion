...
<div className={styles.item} data-type="active">
    ...
    {status === 'active'? <div><button disabled>착용중</button></div> : status=== 'deactive' ? <div><button  onClick={active}>착용하기</button></div>: <div>잔여수량:10000<br/> <button onClick={buyItem}>구매</button></div>}
