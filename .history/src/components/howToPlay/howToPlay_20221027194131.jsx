    ...
    <>
        ...
        <div className={styles.howToPlay}>
            ...
            <div>
                ...
                <strong>SHOP</strong> : 한정 아이템들을 구매가능, 아이템은 오픈 씨 및 해 사이트에서 열람가능. 아이템 판매는 오픈시에서, 기존 로그인 지갑으로 로그인시 가능.<br/>
                MY PAGE: 가지고 있는 아이템과 착용아이템을 확인하고, 아이템 착용 및 해제 가능. 닉네임 변경권 소유시, 이곳에서 닉네임변경이 가능하다. <br/>
                GAME START:<br/>
                <br/>
            </div>
            <div>
