  ...
  <div className={styles.app}>
    ...
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/shop" element={<Shop authService={authService} nickname={nickname} scoreLimit={scoreLimit} myStatus={myStatus} setMystatus={setMystatus} initShopItems={initShopItems}/>}/>
